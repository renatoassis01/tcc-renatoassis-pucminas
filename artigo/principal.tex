...
\noindent
  ...
  Infraestrutura como código ou também conhecida como IaC ou frequentemente descrito como "infraestrutura programável". É um modelo de gerenciamento de recursos computacionais através de arquivos de definição que legível por humanos e são interpretado por ferramentas específicas para essa finalidade para construir e implantar componentes de uma infraestrutura. A infraestrutura como código é adotada primordialmente na computação em nuvem permitindo um fluxo de trabalho totalmente automatizado e a infraestrutura é tratada como código e passam a fazer parte do fluxo de desenvolvimento de software. Este trabalho trata-se de apresentar  conceitos e uma análise de uma categoria de ferramentas de infraestruturas como código.  
