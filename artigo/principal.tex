...
\noindent
  ...
  Infraestrutura como código ou também conhecida como IaC , frequentemente descrita como "infraestrutura programável". É um modelo de gerenciamento de recursos computacionais através de arquivos de definição legíveis para humanos e interpretados por ferramentas específicas para essa finalidade para construir e implantar componentes de uma infraestrutura. A infraestrutura como código é adotada primordialmente na computação em nuvem, permitindo um fluxo de trabalho totalmente automatizado e a infraestrutura é tratada como código e passa a fazer parte do fluxo de desenvolvimento de software. Este trabalho trata-se de apresentar conceitos e uma análise de uma categoria de ferramentas de infraestruturas como código.  Ele é organizado por uma introdução que descreve um contexto geral onde a IaC é aplicada , uma contextualização de um problema e o que a infraestrutura como código se propõem a resolver, as motivações para adoção de ferramentas de IaC, uma análise comparativa entre ferramentas de IaC e uma conclusão.   
